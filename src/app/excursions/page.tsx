...
export const metadata: Metadata = {
  ...
  description: 'Экскурсии в ведущие научные институты на ФизФест 2025. Посетите лаборатории, познакомьтесь с современными исследованиями. Только для совершеннолетних граждан РФ.',
  ...
  openGraph: {
    ...
    description: 'Уникальная возможность посетить ведущие научные институты и лаборатории. Современные исследования, передовые технологии. Регистрация для совершеннолетних!',
